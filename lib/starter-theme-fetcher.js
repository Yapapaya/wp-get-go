 ...
 */
wpggStarterThemeFetcher.fetch = function( bootStrapInfo, options ) {
...
wpggStarterThemeFetcher.fetchRepo = function() {
	...
	if ( this.bootStrapInfo.starter.repository.search( /github/i ) < 0 ) {
		...
		this.svnRemote = this.svnURL( this.bootStrapInfo.starter.repository );
 ...
 * @returns {string} SVN URL
 */
wpggStarterThemeFetcher.svnURL = function( gitURL ) {
